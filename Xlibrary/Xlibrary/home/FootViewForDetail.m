...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context{
    ...
    if([[footViewForDetailModel valueForKey:@"totalNumber"]integerValue] != 0){
        preLablel.text = [NSString stringWithFormat:@"%.1f%%",[[footViewForDetailModel valueForKey:@"oddNumber"]floatValue]/[[footViewForDetailModel valueForKey:@"totalNumber"]floatValue]*100];
    }
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextAddRect(context, CGRectMake(20, 5+40-40*[[footViewForDetailModel valueForKey:@"oddNumber"]floatValue]/[[footViewForDetailModel valueForKey:@"totalNumber"]floatValue], 40, 40*[[footViewForDetailModel valueForKey:@"oddNumber"]floatValue]/[[footViewForDetailModel valueForKey:@"totalNumber"]floatValue]));
    [[UIColor blackColor]setFill];
    CGContextFillPath(context);
    UIImage *pigImage = IMAGE_NAMED(@"pig icon");
    
    [pigImage drawInRect:FRAME(20, 5, 40, 40)];
}
-(void)dealloc{
