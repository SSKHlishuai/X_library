...
-(void)getLocalData
{
    ...
    NSArray *myArr = [[NSDictionary dictionaryWithContentsOfFile:SpendAndIncome_TYPE_PATH]objectForKey:@"spend"];
    
    for(NSDictionary *dict in myArr)
    {
        ManageTypeModel *model = [[ManageTypeModel alloc]initWithDict:dict withType:@"spend"];
